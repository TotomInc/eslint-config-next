...
ruleTester.run("no-unsafe-dictionary-type", noUnsafeDictionaryTypeRule, {
  ...
  invalid: [
    ...
    { code: "type Index<T> = Record<string, T>; type A = Index<unknown>;", errors: [error] },
    ...
    { code: "type Escape = Readonly<unknown>; type A = Record<string, Escape>;", errors: [error] },
    {
    ...
    { code: "type Index<T = unknown> = Record<string, T>; type A = Index;", errors: [error] },
    {
      code: "type Index<T, U = T> = Record<string, U>; type A = Index<string, unknown>;",
      errors: [error],
    },
    { code: "type Index<T, U = T> = Record<string, U>; type A = Index<unknown>;", errors: [error] },
    {
